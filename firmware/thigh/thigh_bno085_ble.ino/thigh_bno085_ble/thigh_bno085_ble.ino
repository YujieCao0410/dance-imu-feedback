...
void setup() {
  ...
  Serial.println("THIGH-B BLE + BNO085");

  Bluefruit.configPrphBandwidth(BANDWIDTH_MAX);

  Bluefruit.begin();
  Bluefruit.setTxPower(4);
  Bluefruit.setName("THIGH-B");
  ...
  Serial.println("BLE UART advertising as THIGH-B");
  ...
  Serial.println("Sending THIGH quaternion over BLE");
}
